...
export default function ProfilePage() {
  ...
  if (error || !profile) {
    return (
      <div className="min-h-screen bg-lienar-to-br from-pink-50 to-red-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-8">
          ...
          <button
            ...
            className="bg-lienar-to-r from-pink-500 to-red-500 text-white font-semibold py-3 px-6 rounded-full hover:from-pink-600 hover:to-red-600 transition-all duration-200"
          >
            Retry
          </button>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-gray-700 space-x-1">
                    <span className="text-gray-900 dark:text-white">
                      Username
                    </span>
